    ...
    public partial class BlogController : Controller
    {
        ...
        public async virtual Task<ActionResult> Feed()
        {
            ...
            if (entries.Any())
            {
                ...
                DateTime? lastModifiedDate = entries.OrderByDescending(e => e.ModifiedTime).First().ModifiedTime;
            ...
            foreach (var blogEntry in entries)
            {
                var syndicationItem = new SyndicationItem(
                    ...
                    blogEntry.ModifiedTime.HasValue ? blogEntry.ModifiedTime.Value : blogEntry.PublishDate);
